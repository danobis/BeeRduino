...
INSERT INTO measurements (uuid, owner_uuid, beehive_uuid, value, type, unit, timestamp)
VALUES
    (0xAABBCCDDEEFF00112233445566778899, 0xF67EC8860051487E81D4932E298496AE, 0xD1280171E8BC4E8F80010B6F74A09847, 35.6, 'SENSOR_TEMPERATURE_INSIDE', 'UNIT_CELSIUS', NOW()),
    (0x11223344556677889900AABBCCDDEEFF, 0xF67EC8860051487E81D4932E298496AE, 0xD1280171E8BC4E8F80010B6F74A09847, 60.2, 'SENSOR_HUMIDITY_INSIDE', 'UNIT_PERCENTAGE', NOW()),
    (0x99887766554433221100FFEEDDCCBBAA, 0x3A0087C4A4874800AB12CBBEF81C0A23, 0x6C5A506607A84A218DC2766CBC63F0EB, 15.3, 'SENSOR_WEIGHT', 'UNIT_GRAM', NOW());
