...
You can then execute your native executable with: `./target/graphql-service-1.0-SNAPSHOT-runner`
...
//TODO: document: if @JsonbTypeAdapter on enum -> stackoverflow exception
